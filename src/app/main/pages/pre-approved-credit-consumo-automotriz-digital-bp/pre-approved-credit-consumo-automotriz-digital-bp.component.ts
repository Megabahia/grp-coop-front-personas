...
@Component({
    ...
    templateUrl: './pre-approved-credit-consumo-automotriz-digital-bp.component.html',
    styleUrls: ['./pre-approved-credit-consumo-automotriz-digital-bp.component.scss']
})
