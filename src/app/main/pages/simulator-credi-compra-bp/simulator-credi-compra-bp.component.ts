...
@Component({
    ...
    styleUrls: ['./simulator-credi-compra-bp.component.scss']
})
export class SimulatorCrediCompraBpComponent implements OnInit {
    ...
    calcular() {
        ...
        this._router.navigate(['/pages/requisitos-de-credito-bp']);
    }
