...
@Component({
    selector: 'app-credit-requirements-digital',
    templateUrl: './credit-requirements-digital.component.html',
    styleUrls: ['./credit-requirements-digital.component.scss']
})
export class CreditRequirementsDigitalComponent implements OnInit, OnDestroy {
    ...
    getInfo() {
        ...
        this.paramService.obtenerListaPadresSinToken('DESCRIPCION_REQUISITOS_CREDICOMPRA_DIGITAL_MICROCREDITOS').subscribe((info) => {
