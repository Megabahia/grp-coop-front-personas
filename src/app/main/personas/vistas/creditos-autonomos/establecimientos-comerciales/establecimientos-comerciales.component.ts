import {Component, OnInit, ViewChild, Output, EventEmitter, ViewEncapsulation, AfterViewInit, OnDestroy} from '@angular/core';
...
export class EstablecimientosComercialesAutComponent implements OnInit, AfterViewInit, OnDestroy {
