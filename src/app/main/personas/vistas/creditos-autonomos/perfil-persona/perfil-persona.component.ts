import {Component, OnInit, ViewChild, Output, EventEmitter, ChangeDetectorRef, AfterViewInit, OnDestroy} from '@angular/core';
...
export class PerfilPersonaAutComponent implements OnInit, AfterViewInit, OnDestroy {
