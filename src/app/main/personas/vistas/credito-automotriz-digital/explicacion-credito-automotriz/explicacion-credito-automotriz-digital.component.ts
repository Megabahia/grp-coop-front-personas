...
@Component({
    selector: 'app-explicacion-credito-automotriz-digital',
    template: `
    ...
    `,
    styleUrls: ['./explicacion-credito-automotriz-digital.component.scss']
})
export class ExplicacionCreditoAutomotrizDigitalComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.paramService.obtenerListaPadresSinToken('CREDITO_AUTOMOTRIZ_DIGITAL_DESCRIPCION_VIDEO_INFORMATIVO').subscribe((info) => {
