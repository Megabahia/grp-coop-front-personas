...
@Component({
    ...
    templateUrl: './credito-automotriz-digital.component.html',
    styleUrls: ['./credito-automotriz-digital.component.scss']
})
export class CreditoAutomotrizDigitalComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private _creditosAutonomosService: CreditoAutomotrizDigitalService,
