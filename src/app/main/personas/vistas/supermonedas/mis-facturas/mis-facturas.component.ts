...
export class MisFacturasComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    cargarFacturaElec(event: any) {
        if (event.target.files && event.target.files[0]) {
            ...
            const aux = this.sizeFile * 1024 * 1024;
    ...
    guardarFacturaFisica() {
        ...
        const facturaFisicaValores = Object.values(this.facturaFisica);
        const facturaFisicaLlaves = Object.keys(this.facturaFisica);
