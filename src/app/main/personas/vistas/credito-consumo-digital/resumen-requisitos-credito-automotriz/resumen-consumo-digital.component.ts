...
export class ResumenConsumoDigitalComponent implements OnInit {
    ...
    inicialidarSolicitudCredito(): SolicitarCredito {
        return {
            ...
            canal: this.tiposNormales['Credito Consumo Digital ' + localStorage.getItem('tipoPersona')] === 'null' ? 'Credito Consumo Digital ' + localStorage.getItem('tipoPersona') : this.tiposNormales['Credito Consumo Digital ' + localStorage.getItem('tipoPersona')] || 'Credito Consumo Negocio propio',
            tipoCredito: this.tiposNormales['Credito Consumo Digital ' + localStorage.getItem('tipoPersona')] || 'Credito Consumo Negocio propio',
            concepto: this.tiposNormales['Credito Consumo Digital ' + localStorage.getItem('tipoPersona')] === 'null' ? 'Credito Consumo Digital ' + localStorage.getItem('tipoPersona') : this.tiposNormales['Credito Consumo Digital ' + localStorage.getItem('tipoPersona')] || 'Credito Consumo Negocio propio',
            cargarOrigen: 'IFIS',
            nombres: '',
            apellidos: '',
    ...
    getInfo() {
        ...
        this.paramService.obtenerListaPadresSinToken('VALOR_MINIMO_SOLICITAR_CREDITO_CONSUMO_DIGITAL').subscribe((info) => {
