...
import {SolicitudCreditosDigitalService} from './solicitud-creditos-digital.service';
...
@Component({
    ...
    templateUrl: './solicitud-creditos-digital.component.html',
    styleUrls: ['./solicitud-creditos-digital.component.scss']
})
export class SolicitudCreditosDigitalComponent implements OnInit {
    // configuracion
    ...
    constructor(
        ...
        private _serviceUpdateEmpresa: SolicitudCreditosDigitalService,
