...
@Component({
  ...
  templateUrl: './creditos-autonomos-digital.component.html',
  styleUrls: ['./creditos-autonomos-digital.component.scss']
})
export class CreditosAutonomosDigitalComponent implements OnInit, AfterViewInit {
