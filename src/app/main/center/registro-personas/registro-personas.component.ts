 ...
 * IFIS
 * PErsonas
 * ESta pantalla sirve para registrar a las personas
 * Rutas:
...
export class RegistroPersonasComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _registroService: RegistroPersonasService,
